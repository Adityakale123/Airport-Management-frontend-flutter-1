...
import '../../presentation/screens/admin/flights/bookings/flight_bookings_screen.dart';
...
import '../../presentation/screens/admin/terminals/add_terminal_screen.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      //here we declareing thr user routes
      ...
      case AppRoutes.adminAddTerminal:
        return MaterialPageRoute(builder: (_) => AddTerminalScreen());
