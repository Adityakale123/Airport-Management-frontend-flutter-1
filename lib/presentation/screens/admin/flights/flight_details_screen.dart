                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 8),
                      Text(
                        flight.aircraftModel ?? 'Aircraft Model N/A',
                        style: TextStyle(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              _buildInfoRow(
                                'Aircraft Model',
                                flight.aircraftModel ?? 'Not specified',
                              ),
                              Divider(height: 24),
                              _buildInfoRow(
                                  'Terminal', flight.terminalName ?? 'TBA'),
                            ],
                          ),
                        ),
                      ),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: CustomButton(
                              text: 'View Bookings',
                              onPressed: () {
                                // Navigate to flight bookings screen
                                Navigator.pushNamed(
                                  context,
                                  AppRoutes.adminFlightBookings,
                                  arguments: {
                                    'flightId': flight.id,
